...
ID = "@(#) $Id: chat_translator_deeptranslator - Monitor Luanti's debug.txt file for lines written by the chat_exporter client-side mod and translate them v1.2.2 (December 30, 2024) by Hubert Tournier $"
